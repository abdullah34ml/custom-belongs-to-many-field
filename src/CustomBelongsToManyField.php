...
use Pifpif\CustomBelongsToManyField\Rules\ArrayRules;

class CustomBelongsToManyField extends Field
{
    ...
    public $component = 'CustomBelongsToManyField';
    ...
    public function optionsShow($optionsShow)
    {
        $this->show = $optionsShow;
        return $this->withMeta(['optionsShow' => $this->show]);
    }
