...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-CustomBelongsToManyField', __webpack_require__(3));
    Vue.component('detail-CustomBelongsToManyField', __webpack_require__(6));
    Vue.component('form-CustomBelongsToManyField', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    showResource: function showResource(resource) {
      var result = "";
      for (var i = 0; i < this.field.optionsShow.length; i++) {
...
var render = function() {
  ...
  return _c(
    "div",
    _vm._l(_vm.field.value, function(resource, index) {
      return _c("span", { key: index }, [
        _c(
          "a",
          {
            ...
            attrs: {
              href: _vm.field.resourceNameRelationship + "/" + resource.id
            }
          },
          [
            _vm._v("\n      " + _vm._s(_vm.showResource(resource))),
            index < _vm.field.value.length - 1
              ? _c("span", [_vm._v(",")])
              : _vm._e()
          ]
        )
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchOptions: function fetchOptions() {
      ...
      var baseUrl = "/nova-vendor/custom-belongs-to-many-field/";
